...
const FIRST_MONTH_METRICS = Object.freeze([
  ...
  },
  {
    ...
    label: "Main Division 진입 시작 학습일수 분포",
    unit: "count",
  ...
  },
  {
    ...
    label: "Main Division 진입 후 강등까지 평균 활동 일수",
    unit: "day",
    category: "main-division",
  },
  {
    key: "main.upward_match_request_success_rate",
    label: "Main 상향 쟁탈전 요청 대비 성립률",
    unit: "percent",
  ...
  },
  {
    ...
    label: "Main 초대 1건당 후보 재선정 횟수",
    unit: "count",
    category: "main-invitation",
  },
  {
    key: "main.invitation_release_reason_distribution",
    label: "Main 초대 예약 학습일수 해제 사유 분포",
    unit: "count",
    category: "main-invitation",
  ...
  },
  {
    ...
    label: "Main 사용자별 경기 학습일수 순이전 분포",
    unit: "day",
    category: "main-economy",
  ...
  },
  {
    ...
    label: "일요일 15시 Main 미정산 경기 보류 건수",
    unit: "count",
    category: "operations",
  },
  {

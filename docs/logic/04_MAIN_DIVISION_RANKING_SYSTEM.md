...
- 문제 형식·승패 우선순위·완전 동점 방어자 승리·증거 제출·무결성 규칙은 Unranked와 같다. 문제 난이도는 티어 차이와 무관하게 방어자 티어의 T1~T9 등급으로 고정하며, 답은 1~999 자연수만 허용한다. 전체 유형·팩·실측 보정 기준은 `02_GOAT_ARENA_COMMON_MATCH_RULES.md` 3절을 단일 원본으로 사용한다.

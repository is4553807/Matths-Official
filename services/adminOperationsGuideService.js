...
const OPERATING_WORKFLOWS = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Unranked 일반 공격은 전 티어 일일 3회 고정이며 방어 상한은 티어별로 확인합니다. 자동 매칭은 같은 대상 티어에서 최근 72시간 일반 쟁탈전 방어 횟수가 가장 적은 후보군을 우선하고, 동률이면 마지막 방어 배정이 가장 오래된 후보를 선택하며 그 시각까지 같을 때만 무작위 선정합니다. 복수전은 일일 상한과 72시간 우선순위 집계에서 제외됩니다.",

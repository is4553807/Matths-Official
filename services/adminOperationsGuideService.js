...
const OPERATING_WORKFLOWS = [
  ...
  },
  {
    ...
    steps: [
      ...
      "문항 번호·문제·선택지·정답·해설을 등록합니다. 공개 상태의 일반 학습 콘텐츠는 표시 문항 수와 정답 데이터 수가 같아야 하며 데일리 하프는 정확히 15문항이어야 합니다.",
  ...
  },
  {
    ...
    steps: [
      "2016~2026 평가원 6·9월 모의평가 42개 수학 형식의 대상 문항 292건을 조사한 공식 유형 분류 현황을 먼저 확인합니다. Arena 범위 265건은 23개 사고 유형과 공개 U1~U9·R1~R9 설계 난이도로 분류되며, 수능과 기하·범위 밖 미적분은 운영 근거에서 제외합니다.",
      ...
      "새 유형은 문제 데이터 화면의 ‘1대1 문제 유형 추가’에서 이름, 승인 생성기 기준 유형과 U/R 배정 범위를 선택합니다. 서버는 기준 생성기를 3회 다시 검산하고 기존 30문항 구성을 유지한 새 카탈로그 버전을 활성화합니다.",

  ...
  SUB: {
    ...
    rules: [
      ...
      },
      {
        ...
        title: "도전 대상과 자동 매칭",
        sections: [
          { title: "상위 순위 우선", body: ["모든 티어에서 서버가 먼저 공격자와 같은 티어이면서 공격자보다 티어 내부 순위가 높은 적격 사용자를 찾습니다.", "같은 티어의 상위 후보가 한 명이라도 있으면 바로 위 티어 후보로 넘어가지 않습니다.", "후보군에서는 최근 72시간 일반 쟁탈전 방어 횟수가 가장 적은 사용자를 먼저 모으고, 동률이면 마지막 방어 배정이 가장 오래된 사용자를 우선합니다. 그 시각까지 같을 때만 무작위로 한 명을 정합니다.", "복수전은 72시간 방어 횟수와 마지막 방어 배정 집계에서 제외하며, 상대의 닉네임이나 특정 계정은 직접 고를 수 없습니다."] },
